class AddProductForm extends React.Component {
  ...
  async sendData() {
    if (this.state.name === '' || this.state.availableQuantity === '' || this.state.price === '' || this.fileInput.current.files[0].name === '') {
    ...
    let request = await fetch('/admin/add-product/data', {
      method: 'POST',
      headers: {
    ...
    if (response.message === 'Sucessfull operation') {
      ...
      request = await fetch('/admin/add-product/photo', {
        method: 'POST',
        body: photo
      });
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "mb-3"
    }, /*#__PURE__*/React.createElement("p", null, "Descripcion/Nombre del producto:"), /*#__PURE__*/React.createElement("input", {
      type: "text",
      ...
      className: "mb-3"
    }, /*#__PURE__*/React.createElement("p", null, "Cantidad disponbile:"), /*#__PURE__*/React.createElement("input", {
      type: "number",
      value: this.state.availableQuantity,
      onChange: this.changeProductAvailableQuantity,
      name: "c"
    })), /*#__PURE__*/React.createElement("div", {
      className: "mb-3"
    }, /*#__PURE__*/React.createElement("p", null, "Precio:"), /*#__PURE__*/React.createElement("input", {
      type: "number",
    ...
    }, "Imagen/Foto del producto: "), /*#__PURE__*/React.createElement("input", {
      type: "file",
      ref: this.fileInput,
      name: "e"
